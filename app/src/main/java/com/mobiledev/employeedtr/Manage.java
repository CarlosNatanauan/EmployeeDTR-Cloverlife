...
public class Manage extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ImageButton btIN = view.findViewById(R.id.btADD);
        ImageButton btOUT = view.findViewById(R.id.btVIEW);

        btIN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), manageAdd.class);
        ...
        btOUT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), manageView.class);
                startActivity(intent);
            }
        });
    }
